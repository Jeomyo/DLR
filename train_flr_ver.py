...
def main():
    ...
    parser.add_argument('--use-flr',
        type=int,
        default=1,          # 1 = FLR ON, 0 = FLR OFF
        help='1: use FLR module, 0: disable FLR'
    )
    ...
    use_flr = bool(args.use_flr)

    net = Network(use_flr=use_flr).cuda(LOCAL_RANK) 
    ...
    for epoch in range(config.epoch_num):
        ...
        for idx, batch in enumerate(train_ds):
            ...
            img, depth, depth_mask, pp_inst, pp_sem, pp_valid_mask = batch
